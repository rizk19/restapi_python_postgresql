    ...
    def get_products(self):
        try:
            ...
            with connection.cursor() as cursor:
                cursor.execute("SELECT PRODUCT_ID, PRODUCT_TYPE_ID, PRODUCT_CODE, PRODUCT_BRAND, PRODUCT_NAME, PRODUCT_CREATION_DATE, PRODUCT_UPDATE_DATE, PRODUCT_LAST_USER FROM PRODUCTS ORDER BY PRODUCT_NAME ASC")
